...
- **代码状态：** `master` 自 2026-06-05 以来无新业务提交；现有组件、store、middleware、utils 与 2026-06-05 记录一致。
- **规则与路径：** `CLAUDE.md`、`docs/rules/*.md` 中引用的文件与符号逐条复核，均与现状一致。
- **PR 状态：** 2026-06-07 和 2026-06-09 维护 PR 仍处于打开状态，本次在其基础上追加日期更新与 sitemap 刷新。

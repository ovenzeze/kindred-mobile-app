...
| 变量 | 说明 |
|------|------|
| `NUXT_PUBLIC_API_BASE_URL` | 后端 API 基址，默认 `https://kapi.deth.us/api/v1` |
...
- **2026-05-21:** 文档维护：默认 API 基址对齐 `kapi.deth.us`；agent-browser 验收改 curl health；字体加载与 shadcn 规则同步。
